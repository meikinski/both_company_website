        ...
        <div className="nutzensection_content">
            ...
            <div className="nutzensection_card">
                <div className='nutzensection_card_title'>
                    ...
                    <p>Im Team oder für sich alleine - durch die Kenntnis über die eigenen Stärken und Schwächen kann die Produktivität und die Stimmung am Arbeitsplatz verbessert werden.</p>
            </div>
            <div className="nutzensection_card">
                <div className='nutzensection_card_title'>
                    <img src={Logo} alt="Favicon" className='nutzensection_card_favicon'/>
